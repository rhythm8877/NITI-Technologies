...
const NBSEPrivacyPolicies = () => {


  return (
    <div>
      <div className='home_div_three'>
        <p className='home_div_three_header'>Privacy Policy for <span style={{color:"#0094d0"}}>NBSE Connect</span></p>
        <div className="termscontainer">
          <div>
            <p className="terms-Title">Privacy Policy</p>
            <p className="policy-Txt">The NBSE Connect is developed and maintained by NITI Technologies, with a primary focus on providing a platform for teachers to enroll themselves and headmasters can pass-on notifications & circulars.</p>
            ...
            <ul>
              <li>
                  <p>All your personal and attendance details are retained as long as you use NBSE Connect App.</p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p>Face recognition-based attendance management is exclusively available for registered NBSE officers and is not accessible to public users. This ensures the system's privacy and security, restricting its use to authorized personnel only.</p>
              </li>
              <li>
                <p>Face data, i.e., the picture collected, is utilized solely to mark the attendance of specific NBSE officers.</p>
              </li>
              <li>
...
export default NBSEPrivacyPolicies
