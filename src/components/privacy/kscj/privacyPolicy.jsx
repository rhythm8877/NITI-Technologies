...
const KSCJPrivacyPolicies = () => {


  return (
    <div>
      <div className='home_div_three'>
        <p className='home_div_three_header'>Privacy Policy for <span style={{color:"#0094d0"}}>Kohima Science College</span></p>
        <div className="termscontainer">
          <div>
            <p className="terms-Title">Privacy Policy</p>
            <p className="policy-Txt">The Kohima Science College app is developed and maintained by NITI Technologies, with a primary focus on providing a platform for teachers, students and alumni (of Kohima Science College, Jotsoma) to enroll themselves and headmasters can pass-on notifications & circulars.</p>
            ...
            <ul>
              <li>
                  <p>All your personal and attendance details are retained as long as you use Kohima Science College App.</p>
              </li>
              <li>
...
export default KSCJPrivacyPolicies
