  ...
  return (
    <div>
      <div className='home_div_three'>
        <p className='home_div_three_header'>Account Deletion for <span style={{color:"#0094d0"}}>DYRS Nagaland</span></p>
        <div className="termscontainer">
          <div>
            <p className="policy-Txt">
              The DYRS Nagaland app, developed and maintained by NITI Technologies, understands your right to data privacy concerns. Hence, we allow users to request data deletion. Kindly submit the form below to delete your account within 24-48 hours.
            </p>
...
export default DYRSAccountDeletion;
