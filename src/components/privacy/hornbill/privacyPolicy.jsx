...
const HornbillPrivacyPolicies = () => {

  return (
    <div>
      <div className='home_div_three'>
        <p className='home_div_three_header'>Privacy Policy for <span style={{color:"#0094d0"}}>Hornbill Festival</span></p>
        <div className="termscontainer">
          <div>
            <p className="terms-Title">Privacy Policy</p>
            <p className="policy-Txt">The Hornbill Festival app is developed, maintained and owned only by NITI Technologies, with a primary focus on providing a platform to highlight information about Nagaland, and all data in the app are sourced from public domains. Hornbill Festival app is not affiliated with any government entity in any form.</p>
            ...
            <ul>
              <li>
                  <p>All your personal and attendance details are retained as long as you use Hornbill Festival App.</p>
              </li>
              <li>
...
export default HornbillPrivacyPolicies
