...
const BloodConnectPrivacyPolicies = () => {


  return (
    <div>
      <div className='home_div_three'>
        <p className='home_div_three_header'>Privacy Policy for <span style={{color:"#0094d0"}}>Blood Connect</span></p>
        <div className="termscontainer">
          <div>
            <p className="terms-Title">Privacy Policy</p>
            <p className="policy-Txt">The Blood Connect is developed and maintained by NITI Technologies, with a primary focus on providing a platform to find nearby Blood Donors, Hospitals, Emergency Services and contribute by registering as a Donor.</p>
            ...
            <ul>
              <li>
                  <p>All your personal and attendance details are retained as long as you use Blood Connect App.</p>
              </li>
              <li>
...
export default BloodConnectPrivacyPolicies
