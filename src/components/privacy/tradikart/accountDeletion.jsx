...
const TradikartAccountDeletion = () => {
  ...
  return (
    <div>
      <div className='home_div_three'>
        <p className='home_div_three_header'>Account Deletion for <span style={{color:"#0094d0"}}>Tradikart</span></p>
        <div className="termscontainer">
          <div>
            <p className="policy-Txt">
              The Tradikart app, developed and maintained by NIELIT Kohima, understands your right to data privacy concerns. Hence, we allow users to request data deletion. Kindly submit the form below to delete your account within 24-48 hours.
            </p>
...
export default TradikartAccountDeletion;
