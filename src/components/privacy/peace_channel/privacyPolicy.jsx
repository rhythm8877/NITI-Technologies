      ...
      <div className='home_div_three'>
        ...
        <div className="termscontainer">
          <div>
            ...
            <p className="policy-Txt">The Peace Channel is developed and maintained by NITI Technologies, aimed at providing a platform to engage in peace-building activities such as events, volunteering, internships, and contributing to harmony through participation in community-based initiatives.</p>
