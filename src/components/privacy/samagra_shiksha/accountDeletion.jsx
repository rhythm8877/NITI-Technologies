...
const SamagraShikshaAccountDeletion = () => {
  ...
  return (
    <div>
      <div className='home_div_three'>
        <p className='home_div_three_header'>Account Deletion for <span style={{color:"#0094d0"}}>Samagra Shiksha Nagaland</span></p>
        <div className="termscontainer">
          <div>
            <p className="policy-Txt">
              The Samagra Shiksha Nagaland app, developed, maintained and owned only by NITI Technologies, understands your right to data privacy concerns. Hence, we allow users to request data deletion. Kindly submit the form below to delete your account within 24-48 hours.
            </p>
...
export default SamagraShikshaAccountDeletion;
