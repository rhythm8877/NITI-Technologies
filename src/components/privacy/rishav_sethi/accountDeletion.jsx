...
const rishavSethiApp = existingApps.find(app => app.name === 'rishav-sethi-app');

if (rishavSethiApp) {
  app = rishavSethiApp;
} else {
  app = initializeApp(firebaseConfig, 'rishav-sethi-app');
}

const db = getFirestore(app);

const RishavSethiAccountDeletion = () => {
  ...
  return (
    <div>
      <div className='home_div_three'>
        <p className='home_div_three_header'>Account Deletion for <span style={{color:"#0094d0"}}>Er. Rishav Sethi</span></p>
        <div className="termscontainer">
          <div>
            <p className="policy-Txt">
              The Er. Rishav Sethi app, developed and maintained by NITI Technologies, understands your right to data privacy concerns. Hence, we allow users to request data deletion. Kindly submit the form below to delete your account within 24-48 hours.
            </p>
...
export default RishavSethiAccountDeletion;
